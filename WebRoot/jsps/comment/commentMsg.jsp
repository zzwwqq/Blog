	...
	<div class="divContent">
	  <div style="margin: 20px;">
		...
		<br/>
		 ...
		 %>
		<span style="margin-left: 50px;"><a target="_top" href="CommentServlet?method=getCommentList">查看评论信息</a></span>
	  	<span style="margin-left: 50px;"><a target="_top" href="CommentServlet?method=preUpdateComment&id=<%=comment.getId() %>">修改评论信息</a></span>  
	  </div>
	</div>
</div>
